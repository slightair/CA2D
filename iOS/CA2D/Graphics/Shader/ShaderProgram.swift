...
//    }
//
//    class func loadShaders(program: inout GLuint, path: String) -> Bool {
//        program = glCreateProgram()
//
//        var vertexShader: GLuint = 0
//        let vertexShaderPathName = Bundle.mainBundle().pathForResource(path, ofType: "vsh")!
...
//        let fragmentShaderPathName = Bundle.mainBundle().pathForResource(path, ofType: "fsh")!
...
//    }
//
//    class func compileShader(shader: inout GLuint, type: GLenum, file: String) -> Bool {
