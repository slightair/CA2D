...
final class AppDelegate: UIResponder, UIApplicationDelegate {
    ...
    func setUpAppearance() {
        window?.tintColor = UIColor.flatGrayColor()
        ...
        UIToolbar.appearance().barTintColor = UIColor.flatBlackColor()

        UITableView.appearance().backgroundColor = UIColor.flatBlackColor()
        UITableView.appearance().separatorColor = UIColor.flatBlackColorDark()
        UITableView.appearance().indicatorStyle = .White

        UITableViewCell.appearance().backgroundColor = UIColor.flatBlackColor()
        UITableViewCell.appearance().tintColor = UIColor.flatWhiteColor()

        UILabel.appearance().textColor = UIColor.flatWhiteColor()
    }
}
